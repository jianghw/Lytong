...
import com.zantong.mobilecttx.car.adapter.CarManageAdapter;
...
//        }
    ...
    public BaseAdapter<CarInfoDTO> createAdapter() {
        mCarManageAdapter = new CarManageAdapter();
...
//                else{
//                    ToastUtils.showShort(CarManageFragment.this.getActivity(),"查询绑定车辆" + mTimes + "次成功");
//                    LogUtils.i("查询绑定车辆" + mTimes + "次成功");
//                }
            }
