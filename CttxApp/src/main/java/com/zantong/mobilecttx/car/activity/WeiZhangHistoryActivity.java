...
public class WeiZhangHistoryActivity extends BaseMvpActivity<IBaseView, HelpPresenter> implements View.OnClickListener, IBaseView {
    ...
    protected void baseGoEnsure() {
        ...
        if (mServerList.size() < 3) {
            ...
            DialogUtils.createDialog(this, "您的车辆数量已达上限");
        }
    }
