...
package com.zantong.mobilecttx.zxing.client.android.encode;

import com.zantong.mobilecttx.zxing.BarcodeFormat;
import com.zantong.mobilecttx.zxing.EncodeHintType;
import com.zantong.mobilecttx.zxing.MultiFormatWriter;
...
import com.zantong.mobilecttx.zxing.client.result.AddressBookParsedResult;
...
final class QRCodeEncoder {
  ...
  private void encodeFromStreamExtra(Intent intent) throws WriterException {
    ...
    if (!(parsedResult instanceof AddressBookParsedResult)) {
      throw new WriterException("BankResponse was not an address");
    }
