...
import com.zantong.mobilecttx.eventbus.SelectEvent;
...
public class DialogUtils {
	 ...
	 * @param context
	 */
	public static void createSelectDialog(final Context context,final int type ,String title, ArrayList<CommonTwoLevelMenuBean> list) {
...
//				ToastUtils.showShort(context,"选中了" + bean.getId());
//				int type, int status, int imgId, int id, String content, Context context
				EventBus.getDefault().post(new SelectEvent(type,bean.getImgId(),bean.getId(),bean.getContext(),context));
