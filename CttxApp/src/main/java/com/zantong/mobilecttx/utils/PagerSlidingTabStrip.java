...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public OnPageChangeListenerMain mOnPageChangeListenerMain;
	...
	private int indicatorHeight = 26;
	private int indicaorBottom = 16;
...
//			if(shouldExpand){
//				v = ((RelativeLayout) tabsContainer.getChildAt(i)).getChildAt(0);
//			}else{
...
//			if (v instanceof TextView) {
	...
	private void setChangTitleColor(View v){

		TextView fontText1 = (TextView) ((RelativeLayout)(tabsContainer.getChildAt(0))).getChildAt(0);
		fontText1.setTextColor(getResources().getColor(R.color.changtongtitle));
		TextView fontText2 = (TextView) ((RelativeLayout)(tabsContainer.getChildAt(1))).getChildAt(0);
		fontText2.setTextColor(getResources().getColor(R.color.changtongtitle));
		TextView fontText3 = (TextView) ((RelativeLayout)(tabsContainer.getChildAt(2))).getChildAt(0);
		fontText3.setTextColor(getResources().getColor(R.color.changtongtitle));
	}
...
//			lineRight = currentTab.getRight() - misTakeWidth;
		...
		canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height-indicaorBottom, rectPaint);
...
//			}
			...
			scrollToChild(position, (int) (positionOffset * v.getWidth()));
	...
	public void setPageChangListenerMain(OnPageChangeListenerMain mOnPageChangeListenerMain){
		this.mOnPageChangeListenerMain = mOnPageChangeListenerMain;
	}


	public interface OnPageChangeListenerMain{
