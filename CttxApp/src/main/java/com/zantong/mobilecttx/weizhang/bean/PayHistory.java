...
public class PayHistory {
    ...
    public ArrayList<com.zantong.mobilecttx.weizhang.bean.ViolationInfo> getViolationInfo() {
        return ViolationInfo;
    }

    public void setViolationInfo(ArrayList<com.zantong.mobilecttx.weizhang.bean.ViolationInfo> violationInfo) {
