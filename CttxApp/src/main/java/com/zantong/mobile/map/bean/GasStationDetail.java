...
public class GasStationDetail {
    ...
    public String getMinusTenStandard() {
        return minusTenStandard;
    }

    public void setMinusTenStandard(String minusTenStandard) {
        this.minusTenStandard = minusTenStandard;
    }

    public String getMinusTwentyStandard() {
        return minusTwentyStandard;
    }

    public void setMinusTwentyStandard(String minusTwentyStandard) {
