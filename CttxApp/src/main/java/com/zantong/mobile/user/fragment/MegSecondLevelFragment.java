...
import com.zantong.mobile.contract.IMegSecondLevelAtyContract;
import com.zantong.mobile.user.activity.MegDetailActivity;
import com.zantong.mobile.user.activity.MegSecondLevelActivity;
import com.zantong.mobile.user.adapter.MegSecondLevelAdapter;
import com.zantong.mobile.user.bean.Meg;
import com.zantong.mobile.order.bean.MessageBean;
...
import static com.zantong.mobile.user.fragment.MegTypeFragment.MESSAGE_REQUEST_CODE;
