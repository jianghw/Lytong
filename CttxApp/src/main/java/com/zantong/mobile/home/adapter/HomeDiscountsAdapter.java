...
import com.zantong.mobile.contract.home.INativeItemListener;
import com.zantong.mobile.home.bean.ChildrenBean;
import com.zantong.mobile.home.bean.ModuleBean;
    ...
    public View createView(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case ITEM_TYPE_NATIVE:
                resource = R.layout.item_rv_native;
                break;
            case ITEM_TYPE_SHARE:
                resource = R.layout.item_rv_share;
                break;
