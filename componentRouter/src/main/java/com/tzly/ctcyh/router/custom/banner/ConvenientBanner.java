package com.tzly.ctcyh.router.custom.banner;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(R.layout.custom_banner_viewpager, this, true);
    ...
    public ConvenientBanner setPageTransformer(Transformer transformer) {
        try {
            viewPager.setPageTransformer(
                    true,
                    (PageTransformer) Class.forName("com.tzly.ctcyh.router.custom.banner.transforms."
