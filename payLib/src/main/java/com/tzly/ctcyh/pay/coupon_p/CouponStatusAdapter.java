...
public class CouponStatusAdapter extends BaseAdapter<CouponStatusBean> {
    ...
    public void bindViewData(BaseRecyclerViewHolder viewHolder,
        ...
        holder.mImgStatus.setBackgroundResource(statusBean.isEnable()? R.mipmap.pay_ic_coupon_red : R.mipmap.pay_ic_coupon_gray);
        holder.mImgInvalid.setVisibility(statusBean.isEnable() ? View.GONE : View.VISIBLE);
        holder.mImgCoupon.setImageAlpha(statusBean.isEnable() ? 255 : 30);
