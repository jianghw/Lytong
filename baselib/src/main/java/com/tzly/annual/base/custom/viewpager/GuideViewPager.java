package com.tzly.annual.base.custom.viewpager;
...
public class GuideViewPager extends FrameLayout {
    ...
    private IGuideViewPager mIGuideViewPager;
    ...
    public GuideViewPager(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initUI(Context context) {
        LayoutInflater.from(context).inflate(R.layout.custom_header_ct_viewpager, this, true);
    ...
    public void setImageUrls(List<Integer> list, ImageView.ScaleType scaleType,
                             IGuideViewPager IGuideViewPager, List<StartPicBean> mList) {
        if (list != null && list.size() > 0) {
            this.mIGuideViewPager = IGuideViewPager;
    ...
    private class MyPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int pos) {
            ...
            mIGuideViewPager.getIndex(len - pos);
        }
    }
