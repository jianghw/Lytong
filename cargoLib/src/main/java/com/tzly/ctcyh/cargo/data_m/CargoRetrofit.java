...
public class CargoRetrofit implements IRetrofitUrl {

    private OkHttpClient client = null;

    private static class SingletonHolder {
        private static final CargoRetrofit INSTANCE = new CargoRetrofit();
    }

    public static CargoRetrofit getInstance() {
        return SingletonHolder.INSTANCE;
    }

    private CargoRetrofit() {
    ...
    protected String getDeviceId() {
        return CargoRouter.getDeviceId();
    }
