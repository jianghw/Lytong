...
import com.tzly.ctcyh.cargo.cc.vehicle.view.ViewfinderView;
 ...
 * 行驶证
 */
public class VehicleCameraActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cargo_activity_vehicle_camera);
    ...
    private void setParameters() {
        ...
        surfaceHolder.addCallback(VehicleCameraActivity.this);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case OcrConstant.TAKE_PREVIEW_DATA_OK:
                    ...
                    if (ocrManager == null) {
                        ocrManager = new OcrManager(mHandler, VehicleCameraActivity.this);
                ...
                case OcrConstant.RECOGN_OK:
                    ...
                    //				}
                    //				over = true;
                    String path = "/sdcard/avehicletest.jpg";
                    //				path = "";
                    VehicleInfo vehicleInfo = ocrManager.getResult(path);
                    try {
                        String info = new String(vehicleInfo.getCharInfo(), "gbk").trim();
                        Intent data2 = new Intent();
                        data2.putExtra("vehicleInfo", info);
                        setResult(200, data2);
