...
public class SystemWebViewClient extends WebViewClient {
     ...
     * The method forwards the request to any running www.plugins before using the default implementation.
     *
     * @param view
     * @param request
     */
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        // Flush stale messages & reset www.plugins.
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
        try {
            ...
            // Allow www.plugins to intercept WebView requests.
    ...
    private static boolean needsSpecialsInAssetUrlFix(Uri uri) {
        if (CordovaResourceApi.getUriType(uri) == CordovaResourceApi.URI_TYPE_ASSET || CordovaResourceApi.getUriType(uri) == CordovaResourceApi.URI_TYPE_HTTP) {
            return true;
        }
