...
public class CordovaPlugin {
     ...
     * Final because we want to be able to change args without breaking www.plugins.
     */
     ...
     * the request. If all www.plugins return null, the default policy will be
     * enforced. If at least one plugin returns true, and no www.plugins return
     ...
     * returns false, Cordova will block the navigation. If all www.plugins return
     * null, the default policy will be enforced. It at least one plugin returns
     * true, and no www.plugins return false, then the navigation will proceed.
     */
     ...
     * www.plugins return null, the default policy will be enforced. If at least one
     * plugin returns true, and no www.plugins return false, then the URL will be
     * opened.
     */
    ...
    /**
     * Allows www.plugins to handle a link being clicked. Return true here to cancel the navigation.
     *
    ...
    /**
     * Hook for redirecting requests. Applies to WebView requests as well as requests made by www.plugins.
