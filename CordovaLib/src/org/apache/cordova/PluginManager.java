...
public class PluginManager {
    ...
    /**
     * Send a message to all www.plugins.
     *
     ...
     *
     * This delegates to the installed www.plugins, and returns true/false for the
     * first plugin to provide a non-null result.  If no www.plugins respond, then
